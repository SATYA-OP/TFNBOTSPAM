...
RAID = [
    "TERE AMMA CHODENGA ABH TERA BAAP TFN OP",
    "OP HU MADARCHOD TERI MAA KI CHUT ME GHUTKA KHAAKE THOOK DUNGA 🤣🤣",
    "HU TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    " OP HU TERI VAHEEN NHI HAI KYA? 9 MAHINE RUK SAGI VAHEEN DETA HU 🤣🤣🤩",
    " OP HU TERI MAA K BHOSDE ME AEROPLANEPARK KARKE UDAAN BHAR DUGA ✈️🛫",
    " OP HU TERI MAA KI CHUT ME SUTLI BOMB FOD DUNGA TERI MAA KI JHAATE JAL KE KHAAK HO JAYEGI💣",
    " OP HU TERI MAAKI CHUT ME SCOOTER DAAL DUGA👅",
    " OP HU TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    " OP HU TERE BEHEN K CHUT ME CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    " OP HU TERI MAA KI CHUT KAKTE 🤱 GALI KE KUTTO 🦮 ME BAAT DUNGA PHIR 🍞 BREAD KI TARH KHAYENGE WO TERI MAA KI CHUT",
    " OP HU DUDH HILAAUNGA TERI VAHEEN KE UPR NICHE 🆙🆒😙",
    " OP HU TERI MAA KI CHUT ME ✋ HATTH DALKE 👶 BACCHE NIKAL DUNGA 😍",
    " OP HU TERI BEHN KI CHUT ME KELE KE CHILKE 🍌🍌😍",
    " OP HU TERI BHEN KI CHUT ME USERBOT LAGAAUNGA SASTE SPAM KE CHODE",
    " OP HU TERI VAHEEN DHANDHE VAALI 😋😛",
    " OP HU TERI MAA KE BHOSDE ME AC LAGA DUNGA SAARI GARMI NIKAL JAAYEGI",
    " OP HU TERI VAHEEN KO HORLICKS PEELAUNGA MADARCHOD😚",
    " OP HU TERI MAA KI GAAND ME SARIYA DAAL DUNGA MADARCHOD USI SARIYE PR TANG KE BACHE PAIDA HONGE 😱😱",
    " OP HU TERI MAA KO KOLKATA VAALE JITU BHAIYA KA LUND MUBARAK 🤩🤩",
    " OP HU TERI MUMMY KI FANTASY HU LAWDE, TU APNI BHEN KO SMBHAAL 😈😈",
    " OP HU TERA PEHLA KAAL HU MADARCHOD ",
    " OP HU TERI VAHEEN KE BHOSDE ME XVIDEOS.COM CHALA KE MUTH MAARUNGA 🤡😹",
...
RRAID = [
    ...
    "BHOSDIKE",
    "BAAL",
    "EK BAAT YAAD RAKH BEHEN KE LUND",
    "THE FURIOUS EMPIRE TERA BAAP HA SAMJHA",
    "TERI MA KI CHUT..",
    "LWDE KE BAAALLL.",
    ...
    "KIDSSSSSSSSSSSS",
    "TERI DIDI KI CHUT ME TFN KA LUND",
    "TERE MA KA PATI TFN OP",
    "TERE MA KA DOODH NIKAL KE TERE BEHEN KO PILA DUNGA",
    "TERE AMMA CHAKKANCHOD HA RANDI KE CHODE",
    "CHUDI HU RANDI KE BETE TFN PAPA BOL",
    "ABH TERE BASS MA CHUDI ABH TERA KHANDAN CHODNE KI BARIII",
    ...
    "NIKAL MADARCHOD",
    "RANDI KE BACHE",
    "TERE MA KI CHUT CHODNE WALE TERE BAAP",
    "FARAR HO GAYA CHINAR KE BETE",
    "TERA MAA MERI FAN",
    "TERI SEXY BAHEN KI CHUT OP",
    "TFN PAPA HA TERE RANDI KE",
    "TFN TERE DIDI KO CHOD KE TERE JIJA BAN GAYE",
    "BETA PURI DUNIY ME SABH KRNA PR TERE TFN PAPA KO UNGLI NI KRNA",
]
